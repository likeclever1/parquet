        ...
        <ul class="info-block__list">
            ...
            ?>
                    <li class='info-block__item'>
                        <a href='/catalog/<?=$typeData['url']."/".$brandData['url']."/".$row['url'];?>' class='b-shipment'>
        ...
        <ul class="info-block__list">
            <?php
                while( $row = mysqli_fetch_assoc($resourseNewsItem) ) {
                    ...
                    echo "<a href='index.php?type=".$typeData['url']."&brand=".$brandData['url']."&shipment=".$row['url']."' class='b-shipment'>";

                    echo "<div class='b-shipment__img'>";
                    echo "<img src='/upload/images/shipment/".$row['image']."' alt='".$row['title']."' '>";
                    echo "</div>";

                    echo "<div class='b-shipment__type'><b>Паркетная доска ".$brandData["title"]."</b></div>";
